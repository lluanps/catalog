package com.luanpinheiro.dscatalog.resources;
...
public class ProductResourceTests {
	...
	void setUp() throws Exception {
		...
		when(service.update(eq(nonExistingId), any())).thenReturn(productDTO);
		
		
		//quando o metodo é void muda a sequencia, ficando primeiro a "consequencia" depois o "when"
	...
	@Test
	public void productByIdShoudThrowResourceNotFoundExceptionWhenIdExists() {
	...
	@Test
	public void productByIdShoudReturnProductDTOWhenIdExists() {
